...
function decodeSecret(matrix, path) {
    let row = 0;
    let col = 0;
  
    let password = String.fromCharCode(matrix[row][col]); 
    ...
    for (let direction of path) {
        ...
        password += String.fromCharCode(matrix[row][col]);
    }
    
    return password;
}

console.log(decodeSecret(arr, str)); 
